...
1. Introduction to object-oriented programming
    ...
    * The method printPerson contains one line of code that makes use of the instance variables name and age. Instance variables are referred to with the prefix **this**.
